    ...
    return (
      <div className="owl-carousel owl-thumbs-3">
        <div className="thumb text-box">
          ...
          <p>
            In this industry of “Business as usual”, we tend to give you less of
            the same in anything that we do.
          </p>
        ...
        <div className="thumb text-box">
          <h4>Big Data</h4>
          <p>
            To reach the maximum potential of digital marketing, firms use
            social media to create a channel of information.
          </p>
          <a href="#" className="read-more">
            See How <i className="saulticon-arrow-forward" />
          </a>
        ...
        <div className="thumb text-box">
          ...
          <p>
            ...
            type of marketing as well as solely relying on it.
          </p>
          <a href="#" className="read-more">
            See How <i className="saulticon-arrow-forward" />
          </a>
