            ...
            <div className="project-listing col-12">
              <div className="grid clearfix">
                <div className="grid-item grid-item-wide project-thumb welcome-message">
                  <div className="inner">
                    <h1>
                      Hi! We're <span className="text-color">SAULT</span>. A
                      full service digital agency who helps brands stand out.
                      Checkout our work.
                    </h1>
                ...
                <div className="grid-item grid-item-wide project-thumb">
                  <a href="project.html">
                    ...
                    <span className="project-thumb-details">
                      ...
                      <span className="description">
                        The International Typographic Style, a modernist
                        movement impacting many design-related fields
                      </span>
                    </span>
                    <i className="saulticon-arrow-forward" />
                  </a>
                ...
                <div className="grid-item grid-item-wide project-thumb">
                  <a href="project.html">
                    ...
                    <span className="project-thumb-details">
                      ...
                      <span className="description">
                        We are for shortcuts as much as you are, but can the
                        shortcuts help if the direction is wrong?
                      </span>
                    </span>
                    <i className="saulticon-arrow-forward" />
                  </a>
                ...
                <div className="grid-item project-thumb">
                  <a href="project.html">
                    ...
                    <span className="project-thumb-details">
                      ...
                      <span className="description">
                        Scholar MFG, an artful neoluxury leather brand based in
                        LA
                      </span>
                    </span>
                    <i className="saulticon-arrow-forward" />
