                  ...
                  <div className="col-lg-10 mb-3">
                    <div className="mb-4 has-anim ">
                      ...
                      <p className="text-light">
                        Aolestiae voluptates placeat at, ex exercitationem
                        tenetur deserunt molestias quaerat libero voluptate
              ...
              <div className="about-me-block">
                ...
                <div>
                  <p className="h5 font-weight-light text-white mb-3 has-anim ">
                    FWA of the Month{' '}
                    <span className="mx-2 d-inline-block text-muted">━━</span>{' '}
                    3x
                  </p>
