...
This is basically the tool that can or cannot be used for creating a new React Native app. The official React Native (Getting Started) docs also describe it.  
...
Hopefully, I am expecting that you gained some points on this framework. Further, you can view their docs for getting started with it.  
